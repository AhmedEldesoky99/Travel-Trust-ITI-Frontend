...
const Login = () => {
  ...
  const { userLoginMutation } = useUserAuth();
  const { mutate, isLoading } = userLoginMutation();
  ...
  return (
    <div className="flex 2xs:flex-col lg:flex-row ">
      <div className="relative 2xs:h-[30vh] 2xs:w-[100vw] lg:w-[50vw] lg:h-[100vh]  sm:block 2xs:bg-login-user bg-cover bg-left bg-no-repeat">
