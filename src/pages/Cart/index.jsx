...
const Cart = () => {
  ...
  return (
    <>
      <Navbar/>
      { items !== 0 ?
        <div className="flex flex-row my-10 justify-center gap-40">
            <div className="flex flex-col max-w-[1110px] w-[100vw]">
            <div className="bg-white flex flex-row w-full h-28 border border-gray-200 items-center p-7 rounded-2xl justify-between mb-8">
                ...
                <div
                className="text-[#DB3A34] flex flex-row items-center"
                onClick={clear}
                >
            ...
            <div className="flex flex-col gap-9">{tourCards}</div>
            </div>
