...
const Footer = () => {
  return (
    <>
      <div className="grid grid-cols-5 2xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 space-x-4 space-y-4 p-10 bg-[#0b0b0b] text-white">

        <div className="text-sm">
          <img src={Logo} alt="Travel Trust Logo" />
          <p className="mt-2">
            Discover some of Egypt’s antiquateson private <br /> tours with an
            egyptian guide .
          </p>
        </div>

        <div className="flex flex-col space-y-2 text-sm">
          <span className="footer-title opacity-100">Quick Links</span>
        ...
        <div className="flex flex-col space-y-2 text-sm">
          <span className="footer-title opacity-100">Top destinations</span>
        ...
        <div className="flex flex-col space-y-2 text-sm">
          <span className="footer-title opacity-100">Get the app</span>
      ...
      <div className="divider after:bg-[#a4a4a4] before:bg-[#a4a4a4] bg-[#0b0b0b] m-0 px-10"></div>

      <div className="flex 2xs:flex-col 2xs:space-y-2 2xs:items-center md:flex-row md:justify-between md:items-center md:space-x-5 md:space-y-0 p-2 bg-[#0b0b0b] text-white px-10">
