    ...
    <>
      <header className="relative hero place-items-start min-h-[58vh] bg-DestinationsBg  min:w-full  ">
        ...
        <div className="container mx-auto">
          <div className="ml-4 xs:ml-0 absolute bottom-0  translate-y-1/2 flex min-w-[60%]  md:min-w-[34.8%] min-h-[8.5rem] md:min-h-[10.3rem] bg-white pr-0 md:pr-6 rounded-md shadow-md  ">
