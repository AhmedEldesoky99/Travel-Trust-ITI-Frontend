      ...
      <section className="z-0">
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
          <div className="flex flex-col lg:flex-row justify-between ">
            <div className="w-full lg:w-6/12 flex flex-col justify-center text-center md:px-10 md:-order-0 h-[458px]">
              <h1 className="text-3xl lg:text-4xl font-bold leading-9 pb-4 text-primary-green">
                Our mission
              </h1>
              <p className="font-normal text-base leading-8 text-gray-600 text-[20px] md:text-[24px]">
            ...
            <div className="w-full lg:w-6/12 -order-1 overflow-hidden">
              <img
                className="w-full h-full transition duration-700 transform ease-in-out cursor-pointer hover:scale-125"
                src="src\assets\images\AboutUs\PeopleCamping.jpg"
                alt="A group of People Camping"
              />
            </div>
          </div>
        </div>
        <div className="-translate-y-[20px] lg:-translate-y-[66px] 2xl:container 2xl:mx-auto  lg:px-20  md:px-6 px-4 ">
          <div className="flex flex-col lg:flex-row ">
            <div className="w-full lg:w-6/12 flex flex-col justify-center text-center px-10  text-white bg-black  border-1 border-gray-950 h-[458px]">
            ...
            <div className="w-full lg:w-6/12 overflow-hidden">
              <img
                className="w-full h-[458px] transition duration-700 transform ease-in-out cursor-pointer hover:scale-125"
